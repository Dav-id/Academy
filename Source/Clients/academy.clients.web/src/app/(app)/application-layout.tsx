...
// ⬇️ import the client renderer
import { SidebarTree } from '@/lib/navigation/ui/sidebar-tree'
...
export function ApplicationLayout({ children, tree }: { children: React.ReactNode, tree: NavItemResolved[] }) {    


    console.log('ApplicationLayout', { tree });
