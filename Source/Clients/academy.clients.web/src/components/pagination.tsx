...
export function PaginationPrevious({
  ...
  children = 'Previous',
  onClick,
}: React.PropsWithChildren<{ href?: string | null; className?: string; onClick?: React.MouseEventHandler }>) {
  return (
...
export function PaginationPage({
  ...
  children,
  onClick,
}: React.PropsWithChildren<{ href: string; className?: string; current?: boolean; onClick?: React.MouseEventHandler }>) {
  return (
    <Button
      href={href}
      plain
