...
//            HttpResponseMessage response = await _client.GetAsync("api/v1/users/1");

//            response.EnsureSuccessStatusCode();

//            UserProfileResponse? result = await response.Content.ReadFromJsonAsync<UserProfileResponse>();
